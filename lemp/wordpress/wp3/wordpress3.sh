...
read -p "Domain Name (eg. example.com): " DOMAIN
#read -p "Username (eg. mywpdata):" USERNAME
...
sleep 2;
sudo apt-get install nginx pwgen zip -y
...
wget -O "$DOMAIN" https://raw.githubusercontent.com/bajpangosh/KLOUDBOY-LEMP-Stack/master/php7default
