...
echo -e -n "${YELLOW}Please enter website name: ${NC}" && read domain
...
case $response in
	...
	echo -e "Please, provide us with your domain name: " && read domain
...
\t 2. WordPress language DEFAULT  [ENG]
\n\t 0. Cancel & Quite
\nEnter: "
...
while true; do
  ...
  read rsn
  case $rsn in
    [1]* ) wordpress_lang='ENG';;
    [2]* ) wordpress_lang='RUS';;
    [2]* ) wordpress_lang='ENG';;
    [0]* ) echo -e " ${YELLOW} Cancel and Break.. ${NC}"; break ;;
  esac
done
